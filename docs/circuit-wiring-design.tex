...
Open sub-questions, recorded for the design pass: the $\sigma$-table
column encoding (commit $\hat s_\sigma$ directly as element-class
columns, or the permutation in a form the GKR's fractional terms
consume); whether witness and preprocessing share one commitment tree
per level or stay separate (separate keeps the witness path untouched);
and the exact absorb point of the preprocessing caps relative to
\code{bind\_statement} (before the wiring GKR's $\alpha, \beta$, like
every commitment).
