...
squeezing it. \textbf{That is redundant}, and dropping it is worth 26\% of the
FS chain. Analysed here; \emph{not yet taken}, because it is a change to
Fiat--Shamir and deserves to be a decision rather than an edit.
...
the stack depth shrinks. It also removes the circuit's one circular wire ---
the re-absorbed challenge, taken from the ROOT row that derived it
(\S\ref{sec:builder}) --- after which every \code{m} word is a transcript value
or a constant.
