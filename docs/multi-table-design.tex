...
\begin{enumerate}[nosep]
  \item \textbf{The fat verifier (leading).} Do not delegate: the
        ...
        multiplies $\approx$ a few ms, once per proof,
        count- \emph{and} capacity-independent. Verification goes
        $\approx 11 \to 13$--$16$\,ms; comb delegation
        (\S\ref{sec:open}), already the queued answer if verify time
        matters, would more than offset it.
