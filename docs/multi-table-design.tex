...
below. [Update 2026-08-27: the unmerged jagged transport was \emph{removed}
2026-08-02; the M6 byte-pinned fixtures pin the \emph{merged} transport
(see \code{tests/union\_m6\_fixtures.rs}), and no merged-vs-jagged A/B
remains.]
...
\begin{itemize}[nosep]
  ...
  \item (v0.7) The \emph{merged jagged/ring-switch transport}
        ...
        unmerged jagged transport was later removed, 2026-08-02; the
        byte-pinned fixtures follow the merged transport.]
\end{itemize}
...
growth to the $4\times$ tier). [Update 2026-08-27: the unmerged jagged
transport was removed 2026-08-02 — the merged transport of
\S\ref{sec:merged} is the only one.]
...
Statement glue & \code{flock-prover/src/r1cs\_hashes/chain\_common.rs} (retired 2026-08-14) & unchanged (single-type statements); \\
