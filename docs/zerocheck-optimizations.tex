...
\item[Improvement:] Tag a pooled buffer with its provenance (derived independently at give and take sites) and, on a tagged hit, skip the constant-region writes.
