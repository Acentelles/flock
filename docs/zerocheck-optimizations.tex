...
they reduce zerocheck round~1 from $1477\,$ms to $1205\,$ms ($-18.4\%$) and
whole-proof time by more than $5\%$ single-threaded. Three are ideas ported
...
\emph{Implemented and correctness-verified; performance verification pending
...
\multicolumn{2}{@{}l}{end-to-end (through \S\ref{sec:pmull} state)} &
  \multicolumn{2}{r@{}}{$52{,}364 \to 55{,}021$ comp/s\quad($+5.1\%$, $8/8$)}\\
\bottomrule
\end{tabular}
\end{table}
