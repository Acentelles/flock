...
\item[Result:] Producer $54.3$--$55.9\to48.0$--$51.0\,$ms ($3/3$); tail $31.9\to8.5$ with the new $\approx24$ ms double fold between them; mechanism sum $85.9$--$87.9\to79.9$--$84.5$ ($3/3$ disjoint, avg $-4.9$) at $m{=}32$ 8T grind-free. Zerocheck sub-line sums reach parity with the challenge tree ($\approx117$ vs $\approx116$). Transcript-identical by three tests including a targeted $b\equiv1$ case.
\end{optsummary}
...
\multicolumn{2}{@{}l}{whole campaign, $m{=}32$ BLAKE3 8T (grind-free basis)} &
  \multicolumn{2}{r@{}}{$723.9 \to \approx457\,$ms\quad($\approx1.58\times$; gap to the challenge tree $1.36\times\to\approx1.17\times$)}\\
\bottomrule
\end{tabular}
\end{table}
