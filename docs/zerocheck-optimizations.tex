...
\S\ref{sec:qres}\ register-resident round 2 & representation &
  round 2: $-13.0\%$ & $8/8$\\
\S\ref{sec:qres}\ fused rounds-3+ tail & representation + pass fusion &
  rounds 3+: $-31.8\%$ & $8/8$\\
\S\ref{sec:composedfold}\ composed fold table (PCS open) & work removal &
  open combine: $-17\%$ & decisive\\
\S\ref{sec:streamwit}\ streamed witness builder & work removal &
  witness gen: $-24\%$ & $3/3$\\
\S\ref{sec:lcfold}\ two-stripe word-load fold & work removal &
  lincheck fold: $-32\%$ & $3/3$\\
\midrule
